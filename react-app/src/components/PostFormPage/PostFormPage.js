    ...
    <div className='background-modal'>
      ...
      <div ref={menuRef} className='modal-container'>
        <div className='modal-top-part'>
          <i onClick={() => closeModal(false)} class="xButton fa-solid fa-arrow-left-long"></i>
