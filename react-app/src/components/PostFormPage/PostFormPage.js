      ...
      <div ref={menuRef} className='modal-container'>
        <div className='modal-top-part'>
          ...
          <p className='createNewPost'>Create new post</p>
          {
            ...
            <button style={image ? {visibility:"visible"} : {visibility:"hidden"}} className='share-submit-form-post' type='submit' onClick={handleSubmit}>Share</button>
          }
        </div>
        <div className='someparts'>

          {image ? <i className="fa-regular fa-circle-check xMarkPostModal yesil"></i> :
            <i className="fa-regular fa-circle-xmark xMarkPostModal"></i>}
          <div className='left-part-form-modal'>
            {
              imageLoading &&
              <i className="fa-solid fa-circle-notch fa-spin loadingiconi"></i>
            }
            ...
            <h2 className='h1-drag-photos-here'>Image must be file type of *.jpg *.jpeg *.png *.gif</h2>
          ...
          <div className='right-side-form-modal'>
            ...
            <div className='imgshowshere'>

              {
                image &&
                <img className='imgyay' src={URL.createObjectURL(image)}></img>
              }
